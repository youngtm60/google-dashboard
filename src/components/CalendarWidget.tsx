...
export default function CalendarWidget() {
  ...
  if (isCreating) {
    return (
      <section className="glass-panel animate-fade-in" style={{ padding: "20px", borderRadius: "24px", flex: 1, height: "100%", minHeight: "350px", display: "flex", flexDirection: "column" }}>
  ...
  if (activeEventId && events) {
    ...
    if (activeEvent) {
      return (
        <section className="glass-panel animate-fade-in" style={{ padding: "20px", borderRadius: "24px", height: "100%", minHeight: "350px", display: "flex", flexDirection: "column" }}>
  ...
  return (
    <section className="glass-panel animate-fade-in" style={{ 
      padding: "20px", borderRadius: "24px", flex: 1, height: "100%", minHeight: "350px", display: "flex", flexDirection: "column" 
    }}>
