    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", width: "100%", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyItems: "space-between", marginBottom: "12px", width: "100%", flexShrink: 0 }}>
        <button 
          ...
          style={{ background: "transparent", color: "var(--text-primary)", display: "flex", alignItems: "center", gap: "8px", fontSize: "0.95rem", fontWeight: 700, padding: "8px 12px", borderRadius: "8px", border: "1px solid var(--glass-border)" }}
        >
